...
export default function Select({ filterName, heading, icon, filterButtons }) {
  ...
  return (
    <div>
        <span className="px-2 flex items-center gap-1 text-xs mb-1 rounded-full text-gray-600 absolut top-[-25%] left-3 z-50">
          {icon} {heading}
        </span>
      <div
