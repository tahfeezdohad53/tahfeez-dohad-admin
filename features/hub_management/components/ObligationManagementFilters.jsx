...
function ObligationMangementFilters
() {
    useSetFilterParams();
    ...
    return (
      <div className="w-full  gap-5 px-3 border rounded-md border-gray-200 py-5 flex items-cente justify-betwee ">
        <div className="relative flex-1 flex items-end gap-3">
          ...
          />
          <CiSearch className="absolute left-2 top-[68%] -translate-y-1/2" />
        </div>
...
export default ObligationMangementFilters
